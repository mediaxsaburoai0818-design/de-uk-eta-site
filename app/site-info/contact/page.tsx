      ...
      <section className="sub-hero relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 pt-12 pb-12 md:pt-14 md:pb-16">
          ...
          <p className="text-gray-600">
            Haben Sie eine Frage zur UK ETA oder zu unserem Portal? Füllen Sie das
      ...
      <section className="bg-white reveal">
        <div className="max-w-4xl mx-auto px-6 py-10">
          <div className="bg-gray-50 border border-gray-200 rounded p-4 text-sm text-gray-500">
            <p>
              <strong>Hinweis:</strong> Wir können keine Auskunft über den Status
              eines konkreten UK-ETA-Antrags geben. Wenden Sie sich bei Fragen zum
              Status Ihres Antrags bitte an{" "}
              <a
